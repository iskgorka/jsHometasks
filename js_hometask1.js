...
/*
Результат qwerty
в && 5 це true, тому результат другий операнд
*/
...
/* Результат true
!!'false' перетворюється в true оскільки будь-який непорожній рядок, включаючи 'false', вважається істинним, 
...
0 || 1
0 рахується як фолс, а оскільки один із операндів тру (1), тому результат будет другий операнд
*/
